...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls==0:
        ...
        new_score = roll_dice(num_rolls=num_rolls,dice=dice)
    return new_score
    # END PROBLEM 3
...
def swine_align(player_score, opponent_score):
    ...
    if player_score<10 or opponent_score<10:
        return False
    Start_Divisor = min(player_score,opponent_score)
    while Start_Divisor>=10:
        if player_score % Start_Divisor == 0:
            if opponent_score % Start_Divisor == 0:
                    return True
        Start_Divisor -= 1
    return False
    # END PROBLEM 4a
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while who == 0:
        if strategy0(score0,score1)==0:
            ...
            score0 += roll_dice(num_of_rolls,dice)
        ...
        while who ==1:
            if strategy1(score1,score0) == 0:
                ...
                score1 += roll_dice(num_of_rolls,dice)
            say = say(score0,score1)
            if score1>= goal:
                flag = 1
                break
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while num_of_dice <= 10:
        ...
        if mid > max:
            max = mid
            finest_num_rools = num_of_dice
        num_of_dice += 1
    return finest_num_rools
    # END PROBLEM 9
